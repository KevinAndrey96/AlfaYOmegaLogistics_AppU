...
public class ServiciosSolicitados extends Activity {
    ...
    class Consulta extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ServiciosSolicitados.this);
                ...
                public void run() {
                    ...
                    lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            String Mensajero = (String) map.get("DATO11");
                            Mensajero=Mensajero.substring(11);
                            if(Mensajero.equals("Espera"))
                            {
                                Toast.makeText(ServiciosSolicitados.this, "Aún no tiene mensajero asignado", Toast.LENGTH_SHORT).show();

                            }
                            else {
                                Intent l = new Intent(ServiciosSolicitados.this, DatosMensajero.class);
                                l.putExtra("Mensajero", Mensajero);
                                startActivity(l);
                            }
                        }
                    });
