 ...
 */
public class HistorialServicios extends Activity {
    @Override
    ...
    class Consulta extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(HistorialServicios.this);
                ...
                public void run() {
                    ...
                    lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            String Categoria = (String) map.get("DATO1");
                            Toast.makeText(HistorialServicios.this, Categoria, Toast.LENGTH_SHORT).show();
